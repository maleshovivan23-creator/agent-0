...
from agent.config import get_env, get_float, load_environment
...
def get_platforms(platform: str | None = None):
    if platform:
        selected = [platform]
    else:
    ...
    for platform in get_platforms(platform_name):
        ...
        for contract in contracts:
            prompt = (
                ...
                f"Produce a concise, usable deliverable that can be submitted to the marketplace."
            )
